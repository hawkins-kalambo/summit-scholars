...
export default function RegisterPage() {
  ...
  return <AuthShell title="Create your student account" description="Registration is free. Verify your email to access your account; course admission is a separate review.">

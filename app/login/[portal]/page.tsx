...
export default async function PortalLogin({ params }: { params: Promise<{ portal: string }> }) {
  ...
  return <AuthShell title={portalLabels[portal] + " sign in"} description={portal === "student" ? "Sign in to apply and access your student account." : "Sign in with your assigned " + (portal === "admin" ? "administrator" : "staff or tutor") + " account."}>
